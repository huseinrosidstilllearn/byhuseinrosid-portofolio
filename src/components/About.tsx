...
export const About: React.FC = () => {
  return (
    <section id="tentang" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative mx-auto max-w-md lg:max-w-none">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl">
              <img
                ...
                className="w-full h-[480px] sm:h-[560px] object-cover filter contrast-[1.05]"
              />
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <h2 className="font-editorial text-3xl sm:text-5xl text-slate-900 dark:text-white font-medium leading-tight">
            Mendengar Melalui Mata, <br className="hidden sm:inline" />
            <span className="italic text-amber-500/90 dark:text-amber-400">Bercerita Melalui Rasa.</span>
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-slate-700 dark:text-slate-300 font-light leading-relaxed mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10 pt-8 border-t border-slate-200 dark:border-white/10">
            <div className="flex flex-col">
              <div className="w-10 h-10 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 mb-3">

...
const stats = [
  { value: `${JOURNEY_STATS.yearsExperience}+`, label: 'Tahun Berkarya' },
  { value: `${JOURNEY_STATS.totalProjects}+`, label: 'Proyek Selesai' },
  { value: `${JOURNEY_STATS.citiesVisited}`, label: 'Kota Dijelajahi' },
  { value: `${JOURNEY_STATS.clientsServed}+`, label: 'Klien Dipercaya' },
];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-24 pb-16 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <div>
              ...
              <p className="text-white/50 text-sm font-mono tracking-widest uppercase">
                Fotografer · Dokumenter · Lanskap · Komersial
              </p>
            </div>
            ...
            <div className="bento-card p-6 rounded-2xl border border-white/5 max-w-2xl">
              <p className="text-white/75 leading-relaxed text-base">
                {PHOTOGRAPHER_PROFILE.bioShort}
              </p>
              <p className="text-white/55 leading-relaxed text-sm mt-3">
                {PHOTOGRAPHER_PROFILE.bioFull[0]}
              </p>
            </div>
            ...
            <blockquote className="border-l-2 border-amber-500/60 pl-4">
              <p className="text-white/60 text-sm italic leading-relaxed">
                "{PHOTOGRAPHER_PROFILE.philosophy}"
              </p>
            </blockquote>
        ...
        >
          {stats.map((stat) => (
            <div key={stat.label} className="bento-card p-5 rounded-2xl border border-white/5 text-center group hover:border-amber-500/30 transition-colors">
